...
author: "Robert Geitner, Robby Fritzsch and Thomas Bocklitz"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
fig_caption: yes
number_sections: true
vignette: >
  %\VignetteIndexEntry{Implementation of 2D Correlation Analysis}
...
First we need to make the package available and get an example dataset. For
illustration purposes we use the FuranMale dataset from the present corr2D
package.
```{r}
library("corr2D")
...
As the next step we calculate the homo 2D correlation spectra of the FuranMale
dataset using the function corr2d() and the first spectrum of the dataset as
reference spectrum.
```{r}
...
```{r, eval=FALSE, fig.show='hold', fig.cap = "Your figure caption."}
